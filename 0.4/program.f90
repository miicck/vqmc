...
contains
    ...
    implicit none
        ...
        allocate(basis(1))
        basis(1) = atomicState(1,0,0,1)

        call cpu_time(startT)
        call energeticsSlaterSpinless(basis, hydrogenPotential, ITTER, energy)
        call cpu_time(endT)
    ...
    implicit none
        ...
        call cpu_time(startT)
        call energeticsSlater(upBasis, downBasis, heliumPotential, ITTER, energy)
        call cpu_time(endT)
    ...
    implicit none
        ...
        call cpu_time(startT)
        call energeticsSlater(upBasis, downBasis, berylliumPotential, ITTER, energy)
        call cpu_time(endT)
    ...
    implicit none
        ...
        call cpu_time(startT)
        call energeticsSlater(upBasis, downBasis, neonPotential, ITTER, energy)
        call cpu_time(endT)
